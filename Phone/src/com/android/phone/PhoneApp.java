...
public class PhoneApp extends Application implements AccelerometerListener.OrientationListener {
    ...
    /* package */ void dismissCallScreen() {
        if (mInCallScreen != null) {
        	//begin: added by yunzhou.song at 2012/04/07 for bug 250583
        	wakeUpScreen();
        	//end: added by yunzhou.song at 2012/04/07 for bug 250583
            if ((TelephonyCapabilities.supportsOtasp(phone)) &&
                ...
                //begin: remarked by yunzhou.song at 2012/04/07 for bug 250583
//              wakeUpScreen();
                //end: remarked by yunzhou.song at 2012/04/07 for bug 250583
    ...
    /* package */ void updateProximitySensorMode(Phone.State state) {
        ...
        if (proximitySensorModeEnabled()) {
            synchronized (mProximityWakeLock) {
                ...
                //begin: remarked by yunzhou.song at 2012/03/26 for preventing sleep
...
//                        !screenOnImmediately && !horizontal) {
                //end: remarked by yunzhou.song at 2012/03/26 for preventing sleep
                //begin: added by by yunzhou.song at 2012/03/26 for preventing sleep
                if (((state == Phone.State.OFFHOOK) || mBeginningCall) &&
                        !screenOnImmediately) {
                //end: added by by yunzhou.song at 2012/03/26 for preventing sleep
