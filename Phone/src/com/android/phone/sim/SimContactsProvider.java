package com.android.phone.sim;

import com.android.phone.sim.HanziToPinyin.Token;
...
public class SimContactsProvider {
	...
	public SimContactsProvider(Cursor cursor, String sortOrder) {
	...
	public SimContactsProvider(Context context, String sortOrder) {
