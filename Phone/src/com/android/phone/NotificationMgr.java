...
public class NotificationMgr implements CallerInfoAsyncQuery.OnQueryCompleteListener{
    ...
    void notifyMissedCall(String name, String number, String label, long date) {
        ...
        //begin: added by yunzhou.song at 2012/04/14 for bug 257491
        ContentResolver resolver = mContext.getContentResolver();
        ContentValues values = new ContentValues();
        values.put("missed_calls", mNumberMissedCalls);
        resolver.insert(Uri.parse("content://missed_calls"), values);
        Intent intent = new Intent("missed_calls_count_changed");
        mContext.sendBroadcast(intent);
        //end: added by yunzhou.song at 2012/04/14 for bug 257491
    }
