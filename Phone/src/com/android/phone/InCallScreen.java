...
//        mApp.setIgnoreTouchUserActivity(true);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //begin: added by yunzhou.song at 2012/04/16 for bug 257191
        View view = mInCallTouchUi.findViewById(R.id.incomingCallWidget);
        if(view != null) {
        	...
        	params.width = Math.min(display.getWidth(), display.getHeight());
        	view.setLayoutParams(params);
        }
        //end: added by yunzhou.song at 2012/04/16 for bug 257191
