...
public class GsmUmtsAdditionalCallOptions extends
	...
	private static final String BUTTON_PN_KEY    = "button_pn_key"; // added byxiaobo.he 20120316

    private CLIRListPreference mCLIRButton;
    private CallWaitingCheckBoxPreference mCWButton;
	private MSISDNEditPreference mMSISDNButton;// added byxiaobo.he 20120316
    ...
    protected void onCreate(Bundle icicle) {
		...
		mMSISDNButton = (MSISDNEditPreference) prefSet.findPreference(BUTTON_PN_KEY); // added byxiaobo.he 20120316

        mPreferences.add(mCLIRButton);
        mPreferences.add(mCWButton);
		mPreferences.add(mMSISDNButton); //added byxiaobo.he 20120316
