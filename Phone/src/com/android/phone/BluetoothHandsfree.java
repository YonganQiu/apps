...
public class BluetoothHandsfree {
    ...
    private class BluetoothPhoneState {
        ...
        private synchronized void handlePreciseCallStateChange(boolean sendUpdate,
            ...
            case DIALING:
                callsetup = 2;
                //begin: added by yunzhou.song for changing audio state while dialing at 2012/05/15
                audioOn();
                //end: added by yunzhou.song for changing audio state while dialing at 2012/05/15
                mAudioPossible = true;
            ...
            case ALERTING:
                ...
                //begin: remarked by yunzhou.song for changing audio state while dialing at 2012/05/15
//                audioOn();
                //end: remarked by yunzhou.song for changing audio state while dialing at 2012/05/15
                mAudioPossible = true;
                break;
            case DISCONNECTING:
