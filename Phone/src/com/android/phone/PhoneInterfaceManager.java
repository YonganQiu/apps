...
public class PhoneInterfaceManager extends ITelephony.Stub {
    ...
    //begin: added by yunzhou.song at 2012/03/27 for bug 235548
    public int supplyPin2(String pin) {
    	enforceModifyPermission();
    	final UnlockSim checkSimPin = new UnlockSim(mPhone.getIccCard());
        checkSimPin.start();
        return checkSimPin.unlockSim2(null, pin);
    }
    //end: added by yunzhou.song at 2012/03/27 for bug 235548
    ...
    //begin: added by yunzhou.song at 2012/03/27 for bug 235548
    public int supplyPuk2(String puk, String pin) {
        enforceModifyPermission();
        final UnlockSim checkSimPuk = new UnlockSim(mPhone.getIccCard());
        checkSimPuk.start();
        return checkSimPuk.unlockSim2(puk, pin);
    }
    //end: added by yunzhou.song at 2012/03/27 for bug 235548
    ...
    private static class UnlockSim extends Thread {
        ...
        synchronized int unlockSim2(String puk, String pin) {
