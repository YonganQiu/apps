...
public class CallLogProvider extends ContentProvider {
    ...
    //{Added by yongan.qiu on 2012.6.27 begin.
    //For add "group by" when query call log and need distinct number (alias #group_by_number).
    private static final int CALLS_GROUP_BY_NUMBER = 4;
    //}Added by yongan.qiu on end.
    ...
    static {
        ...
        //{Added by yongan.qiu on 2012.6.27 begin. For #group_by_number.
        sURIMatcher.addURI(CallLog.AUTHORITY, "calls/group_by_number", CALLS_GROUP_BY_NUMBER);
        //}Added by yongan.qiu on end.
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //{Modified by yongan.qiu on 2012.6.27 begin. For #group_by_number.
        //old:
        /*Cursor c = qb.query(db, projection, selectionBuilder.build(), selectionArgs, null, null,
                sortOrder, null);*/
        //new:
        Cursor c = qb.query(db, projection, selectionBuilder.build(), selectionArgs, groupBy, null,
                sortOrder, null);
