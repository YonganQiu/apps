        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    public boolean isFilterPhones() {
		return mFilterPhones;
	}
    ...
    protected void onCreate(Bundle icicle) {
		...
		//begin: added by yunzhou.song
       mFilterPhones = mPrefs.getBoolean(Constants.PREF_KEY_FILTES_PHONES, false);
		View headerView = inflater.inflate(R.layout.filter_phones_header, null);
		
		final CheckBox filterPhones = (CheckBox) headerView.findViewById(R.id.filter_phones);
		filterPhones.setClickable(false);
		filterPhones.setChecked(mFilterPhones);
		filterPhones.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton buttonView,
					boolean isChecked) {
				mFilterPhones = isChecked;
			}
		});
...
//        if (diff.isEmpty()) {
        ...
        //begin: added by yunzhou.song
		if (diff.isEmpty()
				&& mFilterPhones == mPrefs.getBoolean(
						Constants.PREF_KEY_FILTES_PHONES, false)) {
        //end: added by yunzhou.song
            finish();
            return;
        }
    ...
    public static class UpdateTask extends
        ...
        protected Void doInBackground(
	       ...
	       //begin: added by yunzhou.song
        	...
        	CustomContactListFilterActivity act = (CustomContactListFilterActivity)target;
        	SharedPreferences.Editor editor = act.getPrefs().edit();
        	editor.putBoolean(Constants.PREF_KEY_FILTES_PHONES, act.isFilterPhones());
        	editor.commit();
        	//end: added by yunzhou.song
