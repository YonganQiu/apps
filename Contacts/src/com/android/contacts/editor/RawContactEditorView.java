...
public class RawContactEditorView extends BaseRawContactEditorView {
    ...
    public void setState(EntityDelta state, AccountType type, ViewIdGenerator vig,
        ...
        if (isProfile) {
            ...
            /*if (!TextUtils.isEmpty(accountName)) {*/
            //new:
            if (!TextUtils.isEmpty(accountName) && !hideAccountName) {
            //}Modified by yongan.qiu end.
    ...
    private void updatePhoneticNameVisibility() {
        ...
        if (showByDefault || mPhoneticName.hasData() || mPhoneticNameAdded) {
            mPhoneticName.setVisibility(View.VISIBLE);
            //begin: added by yunzhou.song at 2012/03/31 for bug 248819
            mPhoneticName.requestFocus();
            //end: added by yunzhou.song at 2012/03/31 for bug 248819
        } else {
