...
import android.os.IMMIService; //add by dongsheng.chen 20112.1.12 for 3g Grade
/**
...
public class SpecialCharSequenceMgr {
    ...
    static boolean handleChars(Context context, String input, boolean useSystemWindow,
        ...
        if (handleIMEIDisplay(context, dialString, useSystemWindow)
                ...
                || handleMMIEntry(context, dialString)) {
            return true;
        }
    ...
    //add by dongsheng.chen 2012.1.13 for MMI test
    static boolean handleMMIEntry(Context context, String number){
        if (number.equals("*#09#") || number.equals("*#10#") || number.equals("*#837#")||
                number.equals("*#90#") || number.equals("*#91#") || number.equals("*#92#") //add by dongsheng.chen 2011.12.15 for MMI
                ||number.equals("*#99#")){
            Intent i = new Intent("android.intent.action.MMI");
            i.addCategory("android.intent.category.MMI");
            i.putExtra("type", number);
            context.startActivity(i);
            return true;
        }
        else if(number.equals("*#839#"))          //add by dongsheng.chen 20112.1.12 for 3g Grade
        {
            IMMIService lcdser  = IMMIService.Stub.asInterface(ServiceManager.getService("mmiservice"));
            try {
                if (lcdser != null) {
                    lcdser.setProperty("ctl.start","download_bridge");
//                    String taostMsg = "Service download_bridge has started!";
                    Toast toast = Toast.makeText(context, R.string.toast_service_download, Toast.LENGTH_SHORT);
                    toast.show();
                }
        ...
        else if(number.equals("*#08*#"))          //add by dongsheng.chen 20112.2.16 for MobileSales 
        {
        	try {
        		Log.v(TAG,"number.equals(*#08*#)");
                Intent i = new Intent();
                i.setClassName("com.tct.hz.mobile.sales", "com.tct.hz.mobile.sales.MobileSalesAdmin");
                context.startActivity(i);
			} catch (Exception e) {
