...
public class ContactSelectionActivity extends ContactsActivity
    ...
    protected void onCreate(Bundle savedState) {
        ...
        if (mActionCode != mRequest.getActionCode()) {
            ...
            mMultipleChoice = intent.getBooleanExtra(Constants.EXTRA_MULTIPLE_CHOICE, false);
            View buttonsLayout = findViewById(R.id.layout_bottom);
            buttonsLayout.setVisibility(mMultipleChoice ? View.VISIBLE : View.GONE);
            if(mMultipleChoice) {
            	Button btn = (Button)buttonsLayout.findViewById(R.id.btn_ok);
    ...
    public void configureListFragment() {
        switch (mActionCode) {
            ...
            case ContactsRequest.ACTION_PICK_CONTACT: {
                ...
                fragment.setAccountType(mAccountType);
