...
import com.android.contacts.sim.SimContacts;
import com.android.contacts.util.Constants;

/**
 * SIM Address Book UI for the Phone app.
 */
public class SimContactsImport extends ADNList {
...
//    private ProgressDialog mProgressDialog;
    ...
    private static final int MSG_IMPORT_ALL = 1;
    ...
    Handler nHandler = new Handler(){
    	public void handleMessage(Message msg) {
    		if(msg.what == DISMISS_PROGRESSDIALOG){
...
//    			}
    ...
    private Notification createPrepareNotification(){
    	...
    	.setContentTitle("SIM Prepare to import!")
    	.setTicker("importing")
    	.setProgress(nCursor.getCount(), 0, false);
    	return builder.getNotification();
    }
    
    private Notification createProgressNotification(){
    	Log.d("^^", "progress notification mCount:" + mCount);
    	Notification.Builder builder = new Notification.Builder(this);
    	builder.setOngoing(true)
    	.setSmallIcon(android.R.drawable.stat_notify_sdcard)
    	.setContentText(getString(R.string.percentage,
                String.valueOf(mCount * 100 / mCursor.getCount())))
    	.setContentTitle("SIM importing!")
    	.setTicker("importing")
    	.setProgress(nCursor.getCount(), mCount, false);
    	return builder.getNotification();
    }
...
//    }
    ...
    protected CursorAdapter newAdapter() {
        return new SimpleCursorAdapterInSimContacts(this, R.layout.sim_import_list_entry, mCursor,
