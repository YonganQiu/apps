            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (resId) {
                    ...
                    case R.string.export_to_sim:{
                    	dismissDialog = true;
                    	Intent exportToSimIntent = new Intent("android.intent.action.EXPORT_SIM_CONTACTS");
//                   intent.setType("vnd.android.cursor.dir/phone");
                    	exportToSimIntent.setType("vnd.android.cursor.dir/phone_v2");
//               		 intent.setType("vnd.android.cursor.dir/person");
//               		 intent.setType("vnd.android.cursor.dir/contact");
                    	exportToSimIntent.putExtra("multiple_choice", true);
                    	getActivity().startActivity(exportToSimIntent);
                    	break;
                    }
                    default: {
                        dismissDialog = true;
