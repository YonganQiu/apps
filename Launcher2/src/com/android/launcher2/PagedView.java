...
public abstract class PagedView extends ViewGroup {
    ...
    private static final int MINIMUM_SNAP_VELOCITY = 4000;
    //}modify by jingjiang.yu end
    ...
    protected final static int TOUCH_STATE_QUICK_SLIDE = 50;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
      ...
      //}modify by jingjiang.yu end
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            mTotalMotionX = 0;
            mActivePointerId = ev.getPointerId(0);
          //{modify by zhongheng.zheng at 2012.6.18 begin for quick sliding
//            if (mTouchState == TOUCH_STATE_SCROLLING) {
            if (mTouchState == TOUCH_STATE_SCROLLING || mTouchState == TOUCH_STATE_QUICK_SLIDE) {
        ...
        case MotionEvent.ACTION_CANCEL:
        	//{modify by zhongheng.zheng at 2012.6.18 begin for quick sliding cancel
/*            if (mTouchState == TOUCH_STATE_SCROLLING) {
                snapToDestination();
            }*/
            if (mTouchState == TOUCH_STATE_SCROLLING || mTouchState == TOUCH_STATE_QUICK_SLIDE) {
    ...
    protected void invalidatePageData(int currentPage, boolean immediateAndOnly) {
        ...
        if (mContentIsRefreshable) {
          ...
          //{add by jingjiang.yu at 2012.04.25 begin for Bug264436
