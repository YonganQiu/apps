...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //{modify by jingjiang.yu at 2012.03.22 begin for launcher's portrait orientation display
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    if (mFirstTime) {
                    	...
                    	// fix bug247868, huangxiaodong, 2012.4.10
//                        workspace.post(mBuildLayersRunnable);
                      workspace.postDelayed(mBuildLayersRunnable, 1000);
                      // End
    ...
    */
     ...
     */
    //Modified by yongan.qiu on 2012.3.20 begin. Just change return type.
    //private void completeAddAppWidget(final int appWidgetId, long container, int screen) {
    private boolean completeAddAppWidget(final int appWidgetId, long container, int screen) {
    //Modified by yongan.qiu on 2012.3.20 end. 
    ...
    boolean addAppWidgetImpl(int appWidgetId, PendingAddWidgetInfo info) {
        return addAppWidgetImpl(appWidgetId, info, false);
    }
    //Added by yongan.qiu on 2012.3.20 end.

    //Modified by yongan.qiu on 2012.3.20 begin.
    //void addAppWidgetImpl(int appWidgetId, PendingAddWidgetInfo info) {
    boolean addAppWidgetImpl(int appWidgetId, PendingAddWidgetInfo info, boolean ignoreConfigure) {
        boolean result = false;
    //Modified by yongan.qiu on 2012.3.20 end.
        ...
        if (!ignoreConfigure && appWidget.configure != null) {
        //Modified by yongan.qiu on 2012.3.20 end.
            ...
            result = completeAddAppWidget(appWidgetId, info.container, info.screen);
    ...
    //Added by yongan.qiu on 2012.3.20 begin.
    int addAppWidgetFromExternal(PendingAddWidgetInfo info, long container, int screen,
            int[] cell, int[] loc) {
        resetAddInfo();
        mPendingAddInfo.container = info.container = container;
        mPendingAddInfo.screen = info.screen = screen;
        ...
        if (addAppWidgetImpl(appWidgetId, info, true)) {
            return appWidgetId;
        } else {
            return -1;
        }
        ...
        if (animated) {
            ...
            scaleAnim.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationStart(Animator animation) {
                	//{modify by jingjiang.yu at 2012.04.01 begin for navigationBar's background
...
//                    }
  ...
  //{delete by jingjiang.yu at 2012.03.24 begin for Bug242401
    /**
    @Override
